...
public class MemoryGameService {
    ...
    public MemoryGameEntity save(MemoryGameRequestDto memoryGameRequestDto) throws Exception {
        ...
        Set<CardEntity> newCardSet = memoryGameRequestDto.cardSet().stream()
        ...
        Set<SubjectEntity> subjectSet = memoryGameRequestDto.subjectSet().stream()
...
//                                          .collect(Collectors.toSet());
        ...
        Set<CardRequestDto> cardRequestDtoSet = memoryGameRequestDto.cardSet();
        ...
        Set<String> subjectNameSet = memoryGameRequestDto.subjectSet();
        if (subjectNameSet != null) {
            _deleteAllSubjectNotUsed(memoryGame, subjectNameSet);
            memoryGame.clearSubjectSet(subjectNameSet);
            
            Set<SubjectEntity> subjectSet = subjectNameSet.stream()
                                                          .map(SubjectEntity::new)
                                                          .collect(Collectors.toSet());
            
            Set<SubjectEntity> subjectFoundSet = subjectRepository.findBySubjectSet(subjectNameSet);
